...
//  * @details     Debug Print 시 custom_esp_uart_thread.c 파일을 구분하기 위한 Tag
//  */
...
// /**
//  * @brief       custom_esp_uart_thread.c 파일에서 사용하는 Task Handle
//  * @details     custom_uart_rx_thread의 Task Handle을 저장
//  */
// static volatile TaskHandle_t TaskHandle_custom_uart_rx_thread = NULL;

// /**
//  * @brief       UART TX 큐
//  * @details     UART TX 큐 (utrs)
//  */
// static mpqs mpqs_uart_tx_request;
